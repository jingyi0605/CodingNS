...
- `spec001.3.3-HOST与PEERHOST资源作用域统一与切换收口` 在这个框架上继续补“前端工作台里会话、终端、文件、Git、调试这些资源如何统一表达归属、如何在跨 HOST / 跨工作区切换时先清旧连接再建新连接”的资源作用域模型
...
- `spec001.12-更新通道与预览版本更新体验` 在这个框架上继续补“稳定版 / 开发版如何切换、开发版风险确认和预发布版本规则”的交付边界
