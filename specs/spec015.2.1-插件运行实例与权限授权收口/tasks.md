...
- [ ] 2.1 新增 `PluginPermissionGrant` 表、仓库和权限 key 模型
  - 状态：TODO
...
- [ ] 2.2 重做 `PluginPermissionService`：先看声明，再看授权
  - 状态：TODO
...
- [ ] 3.2 前端插件桥接入 `readFile/writeFile/listDir`
  - 状态：TODO
...
- [ ] 5.1 插件后端动作 payload 补上 `runtimeSessionId`
  - 状态：TODO
