...
- [ ] 3.2 对接 spec003 会话运行时展示
  ...
  - 开始前先看：
    ...
    - `spec003` 的会话运行时接口约定
  - 主要改哪里：
    - `apps/web/src/pages/conversation/context/FileContextPanel.tsx`
    - `apps/web/src/network/sessionContextClient.ts`
