...
- 产品介绍：阅读 [产品概览](/overview/product-overview) 和 [平台与场景](/overview/platforms-and-scenarios)。
- 开发接入：阅读 [开发者手册总览](/developer-guide/) 和 [工作区文件桥与桌面包装](/developer-guide/workspace-file-bridge-and-desktop-wrapper)。
- 安装与连接：阅读 [安装路径选择](/quick-install/installation-paths)、[安装 Host 服务](/quick-install/host-installation) 和 [连接客户端](/quick-install/client-connection)。
- 日常使用：阅读 [工作区与会话](/user-guide/workspaces-and-sessions) 和 [文件、Git 与终端](/user-guide/files-git-and-terminal)。
- 远程访问：阅读 [远程访问概览](/remote-access/remote-access-overview)。
- 社区与支持：阅读 [社区入口](/community/community-overview)。
