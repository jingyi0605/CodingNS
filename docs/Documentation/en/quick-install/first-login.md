...
Make the interface comfortable before you go deeper.

### 2. import or create your first workspace

Bring in an existing project directory or clone a repository into the Host.
...
2. sign in
3. import one workspace
4. open one session
5. inspect files, Git, and terminal access
6. set up remote access only after the basics already work
