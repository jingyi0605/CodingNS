...
- which Host you are connected to;
...
- remote access is hard to understand;
- wording or structure on a page blocks normal use;
- an existing feature feels awkward in a real workflow.
