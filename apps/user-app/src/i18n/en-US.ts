export const enUS = {
  ...
  conversation: {
    ...
    fileViewerPresentationCanvasSelectHint: "Click a component on the canvas to edit it on the right, or switch from the component list above.",
    ...
    fileViewerPresentationSelectNode: "Pick an editable node from the component strip first.",
