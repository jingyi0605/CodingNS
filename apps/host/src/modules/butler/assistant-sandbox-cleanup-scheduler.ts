...
import type {
  AssistantSandboxCleanupResult,
  AssistantSandboxService
} from "./assistant-sandbox-service.js";
...
export class AssistantSandboxCleanupScheduler {
  ...
  private readonly logger: AssistantSandboxCleanupSchedulerLogger;
  ...
  constructor(
    private readonly assistantSandboxService: Pick<AssistantSandboxService, "runDueCleanup">,
    options: AssistantSandboxCleanupSchedulerOptions = {}
  ) {
  ...
  private async tick(shouldScheduleNext = true): Promise<void> {
    ...
    let result: AssistantSandboxCleanupResult | null = null;
    let errorCount = 0;
