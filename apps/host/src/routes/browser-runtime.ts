...
export async function registerBrowserRuntimeRoutes(
  ...
  app.patch("/api/office/browser/profiles/:profileId", browserRuntimeController.updateProfile);
  app.delete("/api/office/browser/profiles/:profileId", browserRuntimeController.deleteProfile);
